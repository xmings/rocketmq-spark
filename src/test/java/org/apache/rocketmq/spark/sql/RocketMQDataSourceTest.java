...
public class RocketMQDataSourceTest {
    ...
    public void testStructuredStreaming() throws Exception {
        ...
        Assertions.assertEquals(100, messageCount);
    }
    ...
    private static int checkTopicData(String topic) throws Exception {
        ...
        for (MessageQueue mq : mqs) {
            PullResult pullResult = consumer.pull(mq, (String) null, 0, 1000);
            if (pullResult.getPullStatus() == PullStatus.FOUND) {
                for (int i = 0; i < pullResult.getMsgFoundList().size(); i++) {
                    ...
                    Assertions.assertEquals("\"Hello Rocket\"", messageBody.substring(0, 14));
                    messageCount++;
                }
            }
        }
